...
export default function PostCommentSection({ postId, currentUserId }: PostCommentSectionProps) {
  ...
  const fetchComments = async () => {
    const { data } = await supabase
      ...
      .select(`
        *,
        author:profiles!info_post_comments_author_id_fkey(name)
      `)
      .eq('post_id', postId)
